...
// Edit one user
router.put("/:id([0-9]+)", [checkJwt_1.checkJwt, checkRole_1.checkRole(["ADMIN"])], UserController_1.default.editUser);
// Edit one user
...
// Delete one user
router.delete("/:id([0-9]+)/forever", [checkJwt_1.checkJwt, checkRole_1.checkRole(["ADMIN"])], UserController_1.default.deleteUserForever);
